...
<main class="ck-main">
    ...
    <div id="resultCard" style="display:none;">
        <div id="errorBox" class="ck-alert" style="display:none;"></div>
...
(function () {
    ...
    function analyze(fd) {
        resultCard.style.display = 'none';
        showOverlay();
        fetch('/fl/fake/analyze.php', { method: 'POST', body: fd })
    ...
    uploadBtn.addEventListener('click', requireLogin);
    uploadBtn.addEventListener('keydown', e => { if (e.key === 'Enter' || e.key === ' ') requireLogin(); });
